...
if __name__ == '__main__':
    ...
    numeros = [random.randrange(1,11) for x in range(3)]
    print('NUMEROS OBTENIDOS: ',numeros)
    suma = sum(numeros)
    if suma <= 21:
        print('GANO LA PARTIDA, PUNTOS OBTENIDOS: ',suma)
    else:
        print('PERDIO LA PARTIDA, PUNTOS OBTENIDOS: ', suma)
    print("terminamos")
